...
export default class Scatterplot {
  ...
  paintDisplay(element, layout, selectionAPI) {
    ...
    const settings = {
      collections: [
        {
          ...
          data: {
            extract: {
              ...
              props: {
                movie: { field: 'qDimensionInfo/0', value: v => v.qText },
                decade: { field: 'qDimensionInfo/1', value: v => v.qText },
      ...
      scales: {
        ...
        decadeScale: {
          data: { extract: { field: 'qDimensionInfo/1', value: v => v.qText } },
          range: ['rgba(109, 232, 193, 0.8)'],
          type: 'color'
        }
      },
      components: [
        ...
        },
        {
          ...
          settings: {
            item: {
              shape: { type: 'circle' },
              label: { fill: 'rgba(109, 232, 193, 0.8)' }
            },
            title: { fill: 'rgba(109, 232, 193, 0.8)' }
          }
        },
        {
          key: 'points',
